...
MainWidget::MainWidget(QWidget *contentWidget, BackgroundWidget *optionPanel, QWidget *parent) : QWidget(parent)
{
...
void MainWidget::update(QWidget *contentWidget, BackgroundWidget *optionPanel)
{
