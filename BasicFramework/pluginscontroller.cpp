...
PluginsController::PluginsController(BasicFramework *mainWindow, QObject *parent) :
    QObject(parent)
{
    registerMetaTypes();

    // alarms database
    _alarmDatabase = new AlarmDatabase(this);
    connect(this, &PluginsController::messagesChanged, _alarmDatabase, &AlarmDatabase::updateMessages);
